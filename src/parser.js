...
exports.parse = function(raw, resolveFn){
    var output = '';
    ...
    output += getRequires(args, factory, resolveFn); // add requires
...
function getRequires(args, factory, resolveFn){
    var requires = [];
    ...
    params.forEach(function(param){
        if ( MAGIC_DEPS[param.dep] && !MAGIC_DEPS[param.name] ) {
            ...
            if (resolveFn != null) { depName = resolveFn(depName); }
